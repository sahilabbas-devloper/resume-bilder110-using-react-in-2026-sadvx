...
function Header() {
  return (
    ...
    <Link to={"/Hero"} className='ml-8 text-sm md:ml-200 text-gray-800 font-semibold hover:text-purple-800'>Hero</Link>
    <Link to={"/Resume"} className='ml-6 text-sm text-gray-800 font-semibold hover:text-purple-800'>preview</Link>
    </div>
